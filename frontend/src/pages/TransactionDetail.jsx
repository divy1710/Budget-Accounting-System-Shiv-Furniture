...
export default function TransactionDetail() {
  ...
  const isVendorType =
    transaction.type === "PURCHASE_ORDER" || transaction.type === "VENDOR_BILL";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <span
            className={`inline-flex px-3 py-1 text-sm rounded-full ${getStatusColor(transaction.status)}`}
          >
            {transaction.status}
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {transaction.paymentAllocations &&
            transaction.paymentAllocations.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm p-6">
